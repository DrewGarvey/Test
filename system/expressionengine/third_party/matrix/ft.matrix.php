...
class Matrix_ft extends EE_Fieldtype {
	...
	// var $bundled_celltypes = array('text', 'date', 'file', 'blue_upload', 'date_no_shift');
	// removed blue_upload as a celltype for externally hosted sites
	var $bundled_celltypes = array('text', 'date', 'file', 'date_no_shift');
