...
class CKEditor
{
	 ...
	 *
	 * Example 1: get the code creating %CKEditor instance and print it on a page with the """ function.
	 * @code
	...
	public function editor($name, $value = "", $config = array(), $events = array())
	{
        ...
        $out .= "<script type=\"text/javascript\" src=\"/cms/expressionengine/third_party/bbr_ckeditor/javascript/wysiwyg_edit.js\"></script>\n";
		$out .= $this->script($js);
