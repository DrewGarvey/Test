...
if (isset($config))
{
	...
	$images_path                       = $base_path . '/ee/' . $images_folder;
	$images_url                        = $base_url . '/ee/' . $images_folder;
	...
	$env_config['theme_folder_path']   = $base_path   . '/ee/themes/';
	$env_config['theme_folder_url']    = $base_url    . '/ee/themes/';
	...
	$env_config['reserved_category_word']   = 'c';
